...
var httpRequestDurationMicroseconds = new prom_client_1.Histogram({
...
var sdk = new sdk_node_1.NodeSDK({
    resource: new resources_1.Resource((_a = {},
        _a[semantic_conventions_1.SemanticResourceAttributes.SERVICE_NAME] = 'handler-api',
...
sdk.start();
var metricsMiddleware = function (app) {
    // Prometheus metrics endpoint
    app.get('/metrics', function (_, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b;
